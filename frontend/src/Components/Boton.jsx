...
const BotonPrincipal = ({ Text, className = '', onClick, isSelected, additionalClasses = '' }) => {
  return (
    <button
      className={`bg-[#00A305] relative cursor-pointer font-semibold overflow-hidden z-10 border border-verde group w-[180px] h-[50px] py-[10px] rounded-[15px] mt-3 self-center `}
      onClick={onClick}
    >
