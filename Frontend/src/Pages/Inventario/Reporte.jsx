  ...
  async function buscarProductos() {
    ...
    try {
      const [productosRes, statsRes] = await Promise.all([
        fetch(`http://localhost:4000/api/productos?proveedor=${encodeURIComponent(selectedProveedor.value)}`),
                ...
                {
                  {
                    'general': 'General',
                    'traslados': 'Traslados',
                    'bajas': 'Historial de bajas-Administración',
                    'bajas2': 'Historial de bajas-Almacenamiento',
                    'reporte': 'Reporte'
                  }[option]
                }
              </span>
