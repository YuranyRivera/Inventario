...
const TableWithActions = ({ title, headers, rows, onEdit, onDelete }) => {
  return (
      ...
      <table className="min-w-full mt-10 table-auto rounded-lg overflow-hidden">
        <thead>
          ...
          {rows.map((row, index) => (
            ...
            >
              ...
              <td className="px-4 py-2 flex space-x-2">
                ...
                <button
                  onClick={() => onEdit(row)}
                  className="bg-green-600 text-white py-1 px-3 rounded flex items-center hover:bg-green-700 transition-colors"
                >
